/**
 * Created by andste.cc@gmail.com on 2018/5/28.
 */
...
export default {
  props: {
    ...
    api: {
      type: String,
      default: process.env.ADMIN_API + '/goods'
    },
    // 获取多个商品API
    multipleApi: {
      type: String,
      default: process.env.ADMIN_API + '/goods/@ids/details'
    },
    // 分类API
    categoryApi: {
      type: String,
      default: `${process.env.ADMIN_API}/goods/categories/@id/children`
    },
    // 最大可选个数
    limit: {
      type: Number,
