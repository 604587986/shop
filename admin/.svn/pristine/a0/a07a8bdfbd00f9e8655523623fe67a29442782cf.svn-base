    ...
    <div class='navBar-container'>
        ...
        <div class='navBarRoute'>
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item v-if='routeAlias[0]'>{{routeAlias[0]}}</el-breadcrumb-item>
                <el-breadcrumb-item v-if='routeAlias[1]'>{{routeAlias[1]}}</el-breadcrumb-item>
                <el-breadcrumb-item v-if='routeAlias[2]'>{{routeAlias[2]}}</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
