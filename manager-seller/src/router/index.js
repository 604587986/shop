...
export const asyncRouterMap = [
  ...
  // 订单管理
  {
    ...
    children: [
      ...
      { path: 'service-detail/:sn', component: () => import('@/views/order/serviceOrderDetail'), name: 'serviceOrderDetail', hidden: true, meta: { title: 'orderDetail' }},
  ...
  // 促销管理
  {
    ...
    alwaysShow:true,
    children: [
      { path: 'full-cut', component: () => import('@/views/promotions/fullCut'), name: 'fullCut', meta: { title: 'fullCut' }, hidden: true },
      { path: 'single-cut', component: () => import('@/views/promotions/singleCut'), name: 'singleCut', meta: { title: 'singleCut' }, hidden: true },
      { path: 'second-half-price', component: () => import('@/views/promotions/secondHalfPrice'), name: 'secondHalfPrice', meta: { title: 'secondHalfPrice' }, hidden: true },
      { path: 'discount-manager', component: () => import('@/views/promotions/discountManager'), name: 'discountManager', meta: { title: 'discountManager' }},
      { path: 'gift-manager', component: () => import('@/views/promotions/giftManager'), name: 'giftManager', meta: { title: 'giftManager' }, hidden: true },
      { path: 'group-buy-manager', component: () => import('@/views/promotions/groupBuyManager'), name: 'groupBuyManager', meta: { title: 'groupBuyManager' }, hidden: true },
      { path: 'time-limit', component: () => import('@/views/promotions/timeLimit'), name: 'timeLimit', meta: { title: 'timeLimit' }, hidden: true },
