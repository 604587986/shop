<template>
	<div class="bg-settings">
		<el-form :model="shopDataForm" ref="shopDataForm" :rules="rules" label-width="200px" class="demo-ruleForm" status-icon>
			<!--店铺名称-->
			<el-form-item label="店铺名称：" prop="shop_name">
				<el-input
					v-model="shopDataForm.shop_name"
					@change="() => { shopDataForm.shop_name = shopDataForm.shop_name.trim() }"
					style="width: 200px;"
					auto-complete="off"
				></el-input>
			</el-form-item>
			...
			<el-form-item label="详细地址：" prop="shop_add">
				<el-input
					v-model="shopDataForm.shop_add"
					@change="() => { shopDataForm.shop_add = shopDataForm.shop_add.trim() }"
					style="width: 200px;"
					auto-complete="off"
				></el-input>
			</el-form-item>
			...
			<el-form-item label="店铺经纬坐标：" prop>
				...
				<span class="QQ-tip">经纬坐标：如120.117768,30.2274
					<a href="http://api.map.baidu.com/lbsapi/getpoint/index.html" target="_blank" style="color:blue">快速查找坐标</a>
				</span>
			</el-form-item>
			<!--联系电话-->
