<template>
	<div>
		<en-table-layout toolbar pagination :tableData="tableData" :loading="loading">
			<div slot="toolbar" class="inner-toolbar">
				<div class="toolbar-btns">
					<el-button type="primary" @click="handleAddCoupon">新增全品类优惠券</el-button>
					<el-button type="primary" @click="handleAddNewCoupon">新增单品类优惠券</el-button>
				</div>
				<div class="toolbar-search">
					<en-table-search @search="searchEvent" @advancedSearch="advancedSearchEvent" advancedWidth="465" advanced placeholder="请输入关键字">
			...
			<template slot="table-columns">
				...
				<el-table-column label="优惠券类型">
					<template slot-scope="scope">
						{{scope.row.type_code === 1?"单品类优惠券":"全品类优惠券"}}
					</template>
				</el-table-column>
				...
				<el-table-column label="操作" width="180">
					<template slot-scope="scope">
						<el-button type="success" @click="handleEditCoupons(scope.row)">修改</el-button>
						<el-button type="danger" @click="handleDeleteGoods(scope.row)">删除</el-button>
					</template>
				</el-table-column>
			</template>
			<el-pagination
		...
		<!--优惠券组件-->
		<Coupon :couponModelShow="couponModelShow" :currentcouponId="currentcouponId" @saveCoupon="saveCoupon"></Coupon>
		<!--新增的针对商品的优惠券组件-->
		<new-Coupon :couponModelShow="newCouponModelShow" :currentcouponId="currentcouponId" @saveCoupon="saveNewCoupon"></new-Coupon>
	</div>
</template>
...
export default {
	...
	methods: {
		...
		/** 单品类优惠券监听 */
		saveNewCoupon(target) {
			this.currentcouponId = "";
			this.newCouponModelShow = false;
			target && this.GET_CouponsList();
		}
	}
};
