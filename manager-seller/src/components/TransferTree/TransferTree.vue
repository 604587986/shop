  ...
  <div class="transfer" :style="{width,height}">
    ...
    <div class="transfer-left">
      ...
      <div class="transfer-main">
        ...
        <en-tree-list
          ref='from-tree'
          @selectCaputure="onselect"
          :treeData="self_from_data"
          :node-key="node_key"
    ...
    <div class="transfer-right">
      ...
      <div class="transfer-main">
        ...
        <en-tree-list @selectCaputure="onselect" :treeData="fromData" class="trees"></en-tree-list>
    ...
    methods: {
      ...
      removeToSource() {
        ...
        newSkeletonHalfCheckedNodes.forEach(item => {
          item[children__] = []
          if (item[pid__] === 0) {
            this.$refs['from-tre'].append(item)
          } else {
