      ...
      <div class="pro-content prom">
        <template v-for="(prom, index) in promotions">
          ...
          <template v-if="prom.full_discount_vo">
            ...
            <div v-if="prom.full_discount_vo.full_discount_gift_do" :key="index" class="prom-item">
            ...
            <div v-if="prom.full_discount_vo.coupon_do" :key="index" class="prom-item">
